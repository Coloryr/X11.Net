...
public partial class Xlib
{
    ...
    /// <returns>Zero on failure</returns>
    [LibraryImport("libX11")]
    public static partial Status XSetCloseDownMode(IntPtr display, CloseDownMode close_mode);
    ...
    /// <returns>Zero on failure</returns>
    [LibraryImport("libX11")]
    public static partial Status XKillClient(IntPtr display, Window resource);
    ...
    /// <returns></returns>
    [LibraryImport("libX11")]
    public static partial ulong XBlackPixel(IntPtr display, int screen_number);
    ...
    /// <returns></returns>
    [LibraryImport("libX11")]
    public static partial ulong XWhitePixel(IntPtr display, int screen_number);
    ...
    [LibraryImport("libX11")]
    public static partial int XDefaultDepth(IntPtr display, int screen_number);
    ...
    /// <returns></returns>
    [LibraryImport("libX11")]
    public static partial Window XDefaultRootWindow(IntPtr display);
    ...
    /// <returns></returns>
    [LibraryImport("libX11")]
    public static partial Window XRootWindow(IntPtr display, int screen_number);
    ...
    [LibraryImport("libX11")]
    public static partial int XScreenCount(IntPtr display);
    ...
    [LibraryImport("libX11")]
    public static partial int XDisplayCells(IntPtr display, int screen_number);
    ...
    [LibraryImport("libX11")]
    public static partial int XDisplayPlanes(IntPtr display, int screen_number);
    ...
    [LibraryImport("libX11")]
    public static partial IntPtr XDisplayString(IntPtr display);
    ...
    [LibraryImport("libX11")]
    public static partial long XExtendedMaxRequestSize(IntPtr display);
    ...
    [LibraryImport("libX11")]
    public static partial long XMaxRequestSize(IntPtr display);
    ...
    [LibraryImport("libX11")]
    public static partial ulong XLastKnownRequestProcessed(IntPtr display);
    ...
    [LibraryImport("libX11")]
    public static partial ulong XNextRequest(IntPtr display);
    ...
    [LibraryImport("libX11")]
    public static partial IntPtr XServerVendor(IntPtr display);
    ...
    [LibraryImport("libX11")]
    public static partial int XVendorRelease(IntPtr display);
    ...
    [LibraryImport("libX11")]
    public static partial int XProtocolVersion(IntPtr display);
    ...
    [LibraryImport("libX11")]
    public static partial int XProtocolRevision(IntPtr display);
    ...
    [LibraryImport("libX11")]
    public static partial int XQLength(IntPtr display);
    ...
    [LibraryImport("libX11")]
    public static partial IntPtr XSetAfterFunction(IntPtr display, XAfterFunctionDelegate after_function);

    [LibraryImport("libX11")]
    public static partial int XGrabServer(IntPtr display);

    [LibraryImport("libX11")]
    public static partial int XUngrabServer(IntPtr display);
    ...
    [LibraryImport("libX11")]
    public static partial int XChangeProperty(IntPtr display, Window window, Atom property, Atom type, int format, int mode, IntPtr data, int nelements);
