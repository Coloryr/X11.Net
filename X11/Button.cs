...
public partial class Xlib
{
    ...
    public static partial Status XGrabButton(IntPtr display, Button button, KeyButtonMask modifiers, Window grab_window,
        [MarshalAs(UnmanagedType.Bool)] bool owner_events, EventMask event_mask, GrabMode pointer_mode, GrabMode keyboard_mode, Window confine_to, FontCursor cursor);

    [LibraryImport("libX11")]
    public static partial Status XGrabPointer(IntPtr display, Window grab_window, [MarshalAs(UnmanagedType.Bool)] bool owner_events, EventMask event_mask,
        GrabMode pointer_mode, GrabMode keyboard_mode, Window confine_to, Cursor cursor, ulong time);

    [LibraryImport("libX11")]
    public static partial Status XUngrabPointer(IntPtr display, ulong time);

    [LibraryImport("libX11")]
    public static partial Status XGrabKey(IntPtr display, KeyCode keycode, KeyButtonMask modifiers, Window grab_window,
        [MarshalAs(UnmanagedType.Bool)] bool owner_events, GrabMode pointer_mode, GrabMode keyboard_mode);

    [LibraryImport("libX11")]
    public static partial Status XUngrabKey(IntPtr display, KeyCode keycode, KeyButtonMask modifiers, Window grab_window);

    [LibraryImport("libX11")]
    public static partial Status XChangeActivePointerGrab(IntPtr display, EventMask event_mask, Cursor cursor, ulong time);

    [LibraryImport("libX11", StringMarshalling = StringMarshalling.Utf8)]
    public static partial KeySym XStringToKeysym(string str);

    [LibraryImport("libX11", StringMarshalling = StringMarshalling.Utf8)]
    public static partial string XKeysymToString(KeySym keysym);

    [LibraryImport("libX11")]
    public static partial KeySym XKeycodeToKeysym(IntPtr display, KeyCode keycode, int index);

    [LibraryImport("libX11")]
    public static partial KeyCode XKeysymToKeycode(IntPtr display, KeySym keysym);
    ...
    /// <returns></returns>
    [LibraryImport("libX11")]
    public static partial Status XUngrabButton(IntPtr display, Button button, KeyButtonMask modifiers, Window grab_window);

    [LibraryImport("libX11")]
    public static partial IntPtr XGetKeyboardMapping(IntPtr display, X11.KeyCode keyCode, int keycode_count, IntPtr keysyms_per_keycode_return);

    [LibraryImport("libX11")]
    public static partial int XChangeKeyboardMapping(IntPtr display, X11.KeyCode keyCode, int keysyms_per_keycode, IntPtr keysys, int num_codes);

    [LibraryImport("libX11")]
    public static partial void XDisplayKeycodes(IntPtr display, IntPtr min, IntPtr max);
}
