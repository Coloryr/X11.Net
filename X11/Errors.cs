...
public partial class Xlib
{
    ...
    public static partial IntPtr XSetErrorHandler(XErrorHandlerDelegate del);
    ...
    [LibraryImport("libX11")]
    public static partial IntPtr XSetIOErrorHandler(XIOErrorHandlerDelegate del);
    ...
    [LibraryImport("libX11")]
    public static partial Status XGetErrorText(IntPtr display, int code, IntPtr description, int length);
    ...
    public static partial Status XGetErrorDatabaseText(IntPtr display, string name, string message, string default_string,
