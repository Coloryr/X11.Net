...
public partial class XTest
{
    ...
    /// <returns></returns>
    [LibraryImport("libXtst")]
    public static partial int XTestFakeButtonEvent(IntPtr display, Button button, int is_press, ulong delay);
    ...
    /// <returns></returns>
    [LibraryImport("libXtst")]
    public static partial int XTestFakeKeyEvent(IntPtr display, KeyCode code, 
        [MarshalAs(UnmanagedType.Bool)] bool is_press, ulong delay);
}
