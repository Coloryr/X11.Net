...
public partial class Xlib
{
    ...
    public static partial Pixmap XCreatePixmap(IntPtr display, Window drawable, uint width, uint height, uint depth);
    ...
    [LibraryImport("libX11")]
    public static partial Status XFreePixmap(IntPtr display, Pixmap pixmap);
}
