...
public partial class Xlib
{
    ...
    public static partial Colormap XDefaultColormap(IntPtr display, int screen_number);
    ...
    /// <returns></returns>
    [LibraryImport("libX11")]
    public static partial Colormap XCreateColormap(IntPtr display, Window window, IntPtr visual, ColormapAlloc alloc);
    ...
    [LibraryImport("libX11")]
    public static partial Colormap XCopyColormapAndFree(IntPtr display, Colormap colormap);
    ...
    [LibraryImport("libX11")]
    public static partial Status XFreeColormap(IntPtr display, Colormap colormap);

    [LibraryImport("libX11")]
    public static partial Status XInstallColormap(IntPtr display, Colormap colormap);

    [LibraryImport("libX11")]
    public static partial Status XUninstallColormap(IntPtr display, Colormap colormap);
    ...
    public static partial Status XParseColor(IntPtr display, Colormap colormap, string spec, ref XColor xcolor_return);
    ...
    /// <returns>Zero on failure</returns>
    [LibraryImport("libX11")]
    public static partial Status XAllocColor(IntPtr display, Colormap colormap, ref XColor screen_in_out);
    ...
    [LibraryImport("libX11")]
    public static partial Status XAllocColorCells(IntPtr display, Colormap colormap, [MarshalAs(UnmanagedType.Bool)] bool contig, ulong[] plane_masks_return,
    ...
    /// <returns></returns>
    [LibraryImport("libX11")]
    public static partial Status XAllocColorPlanes(IntPtr display, Colormap colormap, [MarshalAs(UnmanagedType.Bool)] bool contig,
    ...
    /// <returns>Zero on failure</returns>
    [LibraryImport("libX11")]
    public static partial Status XcmsAllocColor(IntPtr display, Colormap colormap, ref XcmsColor color_in_out,
    ...
    /// <returns>Zero on failure</returns>
    [LibraryImport("libX11")]
    public static partial Status XcmsAllocNamedColor(IntPtr display, Colormap colormap, IntPtr color_string,
    ...
    /// <returns></returns>
    [LibraryImport("libX11")]
    public static partial int XQueryColor(IntPtr display, Colormap colormap, ref XColor def_in_out);
    ...
    /// <returns></returns>
    [LibraryImport("libX11")]
    public static partial Status XcmsQueryColor(IntPtr display, Colormap colormap, ref XcmsColor color_in_out,
        XcmsColorFormat result_format);
    ...
    /// <returns></returns>
    [LibraryImport("libX11")]
    public static partial Status XcmsQueryColors(IntPtr display, Colormap colormap, XcmsColor[] colors_in_out,
    ...
    /// <returns></returns>
    [LibraryImport("libX11")]
    public static partial Status XcmsLookupColor(IntPtr display, Colormap colormap, IntPtr color_string,
    ...
    /// <returns></returns>
    [LibraryImport("libX11")]
    public static partial int XQueryColors(IntPtr display, Colormap colormap, XColor[] defs_in_out, int ncolors);
    ...
    /// <returns>Zero on failure</returns>
    [LibraryImport("libX11")]
    public static partial Status XLookupColor(IntPtr display, Colormap colormap, IntPtr color_name,
    ...
    /// <returns>Zero on failure</returns>
    [LibraryImport("libX11")]
    public static partial Status XStoreColors(IntPtr display, Colormap colormap, XColor[] color, int ncolors);
    ...
    /// <returns>Zero on failure</returns>
    [LibraryImport("libX11")]
    public static partial Status XStoreColor(IntPtr display, Colormap colormap, ref XColor color);
    ...
    /// <returns></returns>
    [LibraryImport("libX11")]
    public static partial Status XcmsStoreColor(IntPtr display, Colormap colormap, ref XcmsColor color);
    ...
    /// <returns>Zero on failure</returns>
    [LibraryImport("libX11")]
    public static partial Status XStoreNamedColor(IntPtr display, Colormap colormap, IntPtr color,
    ...
    /// <returns>Zero on failure</returns>
    [LibraryImport("libX11")]
    public static partial Status XFreeColors(IntPtr display, Colormap colormap, ulong[] pixels,
    ...
    /// <returns></returns>
    [LibraryImport("libX11")]
    public static partial Status XcmsSetWhitePoint(IntPtr ccc, ref XcmsColor color);
    ...
    /// <returns></returns>
    [LibraryImport("libX11")]
    public static partial XcmsWhiteAdjustProc XcmsSetWhiteAdjustProc(IntPtr ccc, XcmsWhiteAdjustProc white_adjust_proc,
        IntPtr client_data);
    ...
    /// <returns></returns>
    [LibraryImport("libX11")]
    public static partial IntPtr XcmsCreateCCC(IntPtr display, int screen_number, IntPtr visual,
    ...
    /// <param name="ccc"></param>
    [LibraryImport("libX11")]
    public static partial void XcmsFreeCCC(IntPtr ccc);
    ...
    /// <returns></returns>
    [LibraryImport("libX11")]
    public static partial IntPtr XcmsCCCOfColormap(IntPtr display, Colormap colormap);
    ...
    /// <returns></returns>
    [LibraryImport("libX11")]
    public static partial IntPtr XcmsSetCCCOfColormap(IntPtr display, Colormap colormap, IntPtr ccc);
    ...
    /// <returns></returns>
    [LibraryImport("libX11")]
    public static partial IntPtr XcmsDefaultCCC(IntPtr display, int screen_number);

    [LibraryImport("libX11")]
    public static partial Status XcmsTekHVCQueryMaxC(IntPtr ccc, double hue, double value,
        ref XcmsColor color_return);

    [LibraryImport("libX11")]
    public static partial Status XcmsTekHVCQueryMaxV(IntPtr ccc, double hue, double chroma,
        ref XcmsColor color_return);

    [LibraryImport("libX11")]
    public static partial Status XcmsTekHVCQueryMaxVC(IntPtr ccc, double hue, ref XcmsColor color_return);

    [LibraryImport("libX11")]
    public static partial Status XcmsTekHVCQueryMaxVSamples(IntPtr ccc, double hue, XcmsColor[] colors_return,
        uint nsamples);

    [LibraryImport("libX11")]
    public static partial Status XcmsTekHVCQueryMinV(IntPtr ccc, double hue, double chroma,
        ref XcmsColor color_return);

    [LibraryImport("libX11")]
    public static partial Status XcmsCIELabQueryMaxC(IntPtr ccc, double hue_angle, double L_star,
        ref XcmsColor color_return);

    [LibraryImport("libX11")]
    public static partial Status XcmsCIELabQueryMaxL(IntPtr ccc, double hue_angle, double chroma,
        ref XcmsColor color_return);

    [LibraryImport("libX11")]
    public static partial Status XcmsCIELabQueryMaxLC(IntPtr ccc, double hue_angle, ref XcmsColor color_return);

    [LibraryImport("libX11")]
    public static partial Status XcmsCIELabQueryMinL(IntPtr ccc, double hue_angle, double chroma,
        ref XcmsColor color_return);

    [LibraryImport("libX11")]
    public static partial Status XcmsCIELuvQueryMaxC(IntPtr ccc, double hue_angle, double L_star,
        ref XcmsColor color_return);

    [LibraryImport("libX11")]
    public static partial Status XcmsCIELuvQueryMaxL(IntPtr ccc, double hue_angle, double chroma,
        ref XcmsColor color_return);

    [LibraryImport("libX11")]
    public static partial Status XcmsCIELuvQueryMaxLC(IntPtr ccc, double hue_angle, ref XcmsColor color_return);

    [LibraryImport("libX11")]
    public static partial Status XcmsCIELuvQueryMinL(IntPtr ccc, double hue_angle, double chroma,
        ref XcmsColor color_return);
}
