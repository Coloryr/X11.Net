...
public partial class Xlib
{
    ...
    public static partial Status XDefineCursor(IntPtr display, Window window, Cursor cursor);
    ...
    /// <returns>zero on error</returns>
    [LibraryImport("libX11")]
    public static partial Status XUndefineCursor(IntPtr display, Window window);
    ...
    [LibraryImport("libX11")]
    public static partial Cursor XCreateFontCursor(IntPtr display, FontCursor shape);
    ...
    /// <returns>Prepared cursor</returns>
    [LibraryImport("libX11")]
    public static partial Cursor XCreatePixmapCursor(IntPtr display, Pixmap source, Pixmap mask,
    ...
    /// <returns></returns>
    [LibraryImport("libX11")]
    public static partial Cursor XCreateGlyphCursor(IntPtr display, Font source_font, Font mask_font, uint source_char,
    ...
    /// <returns></returns>
    [LibraryImport("libX11")]
    public static partial Status XRecolorCursor(IntPtr display, Cursor cursor,
    ...
    /// <returns>zero on error</returns>
    [LibraryImport("libX11")]
    public static partial Status XFreeCursor(IntPtr display, Cursor cursor);
    ...
    /// <returns>zero on error</returns>
    [LibraryImport("libX11")]
    public static partial Status XQueryBestCursor(IntPtr display, Window drawable, uint width, uint height,
